const quizData = [
        ...
        {
            "question": "Quel outil vous permet de visualiser, de surveiller et de déboguer les Workers de votre application ?",
            "options": [
                {
                    "text": "Profiler",
                    "correct": false
                ...
                {
                    "text": "Background Task Inspector",
                    "correct": true
                },
                {
                    "text": "Logcat",
        ...
        {
            "question": "Parmi les options suivantes, lesquelles sont des états de fonctionnement terminal valides ?",
            "options": [
                {
                    "text": "CANCELLED",
                    "correct": true
        ...
        {
            "question": "Parmi les options suivantes, laquelle est un type de demande de travail valide ?",
            "options": [
                {
                    "text": "`OneTimeWorkRequest`",
                    "correct": true
                },
                {
                    "text": "`SingleWorkRequest`",
                    "correct": false
                },
                {
                    "text": "`RepeatingWorkRequest`",
                    "correct": false
                },
                {
                    "text": "`PeriodicWorkRequest`",
                    "correct": true
                }
            ],
            "type": "multiple"
        ...
        {
            "question": "La création et l'ajout à la file d'attente de plusieurs tâches dépendantes, ainsi que l'ordre dans lequel elles doivent s'exécuter, est appelé \"association\".",
            "options": [
                {
                    "text": "Vrai",
                    "correct": false
        ...
        {
            "question": "Parmi les options suivantes, dans quelle situation les contraintes de travail sont-elles utiles ?",
            "options": [
                {
                    "text": "Pour vérifier qu'un mode de paiement valide est enregistré sur l'appareil de l'utilisateur avant que le travail ne soit effectué.",
                    "correct": false
                },
                {
                    "text": "Pour vérifier l'heure avant l'exécution du travail.",
                    "correct": false
                },
                {
                    "text": "Pour vérifier que l'appareil est connecté à un réseau Wi-Fi avant de télécharger une grande quantité de données d'application.",
                    "correct": true
                },
                {
                    "text": "Pour vérifier que l'application a été ouverte un certain nombre de fois avant l'exécution du travail.",
                    "correct": false
                }
            ],
            "type": "single"
        ...
        {
            "question": "Parmi les options suivantes, laquelle permet de transmettre des données d'entrée à un Worker ?",
            "options": [
                {
                    "text": "Transmettre les données en tant qu'argument lorsque vous appelez la fonction `doWork()`.",
                    "correct": false
                },
                {
                    "text": "Utiliser un objet Data pour transmettre des paires clé/valeur.",
                    "correct": true
                },
                {
                    "text": "L'attribuer à la variable `worker.inputData`.",
                    "correct": false
                }
            ],
            "type": "single"
        ...
        {
            "question": "Une fois le travail ajouté à la file d'attente, vous pouvez vérifier son état par ___.",
            "options": [
                {
                    "text": "Nom",
                    "correct": true
        ...
        {
            "question": "Le Background Task Inspector vous permet d'arrêter les Workers pendant leur exécution.",
            "options": [
                {
                    "text": "Vrai",
                    "correct": false
        ...
        {
            "question": "Quel compilateur de workers est recommandé pour tester les `CoroutineWorkers` ?",
            "options": [
                {
                    "text": "`OneTimeWorkRequestBuilder`",
                    "correct": false
                },
                {
                    "text": "`PeriodicWorkRequestBuilder`",
                    "correct": false
                },
                {
                    "text": "`TestWorkerBuilder`",
                    "correct": false
                },
                {
                    "text": "`TestListenableWorkerBuilder`",
                    "correct": true
                }
            ],
            "type": "single"
        ...
        {
            "question": "Lors du test des mises en œuvre de workers, vous pouvez les appeler directement avec `doWork()` au lieu de les ajouter à la file d'attente.",
            "options": [
                {
                    "text": "Vrai",
                    "correct": true
        ...
        {
            "question": "Quelle langue est utilisée pour créer les mises en page de type \"View\" ?",
            "options": [
                {
                    "text": "HTML",
                    "correct": false
        ...
        {
            "question": "Lors de la création d'une application avec des vues, par lequel des éléments suivants doit être remplacé le concept de composable \"écran\" ?",
            "options": [
                {
                    "text": "Fragment",
                    "correct": true
        ...
        {
            "question": "Les liaisons de vue permettent d'accéder aux éléments `View` déclarés au format XML et d'interagir avec eux.",
            "options": [
                {
                    "text": "Vrai",
                    "correct": true
        ...
        {
            "question": "Dans quelle méthode de cycle de vie `Fragment` la liaison des vues est-elle gonflée ?",
            "options": [
                {
                    "text": "`onViewCreated()`",
                    "correct": false
        ...
        {
            "question": "Les composants de la vue sont accessibles avant le gonflement de la liaison des vues.",
            "options": [
                {
                    "text": "Vrai",
                    "correct": false
        ...
        {
            "question": "Un élément `ComposeView` est un(e) :",
            "options": [
                {
                    "text": "Vue pouvant héberger une vue Android dans une interface utilisateur Compose.",
                    "correct": false
                },
                {
                    "text": "Vue Android pouvant héberger le contenu de l'interface utilisateur de Jetpack Compose dans une mise en page de type View",
                    "correct": true
                },
                {
                    "text": "Vue Android pouvant héberger une vue Android dans une mise en page de type View.",
                    "correct": false
                },
                {
                    "text": "Vue pouvant héberger l'interface utilisateur de Compose dans une interface utilisateur Compose.",
                    "correct": false
                }
            ],
            "type": "single"
        ...
        {
            "question": "Jetpack Compose et le système View peuvent coexister dans votre codebase.",
            "options": [
                {
                    "text": "Vrai",
                    "correct": true
        ...
        {
            "question": "`ComposeView` utilise sa méthode ___ pour afficher les éléments Compose à l'écran.",
            "options": [
                {
                    "text": "`Composable()`",
                    "correct": false
                ...
                {
                    "text": "`setComposeContent()`",
                    "correct": false
                },
                {
                    "text": "`displayComposable()`",
                    "correct": false
                }
            ],
            "type": "single"
        ...
        {
            "question": "L'interopérabilité avec les vues a été conçue dès le départ dans Jetpack Compose.",
            "options": [
                {
                    "text": "Vrai",
                    "correct": true
        ...
        {
            "question": "L'indicateur qui permet à Android Studio de fonctionner avec Compose est le suivant :",
            "options": [
                {
                    "text": "Au niveau du projet, utilisez `buildFeatures { compose true }`",
                    "correct": false
                },
                {
                    "text": "Au niveau de l'application, utilisez `buildFeatures { compose true }`",
                    "correct": true
                },
                {
                    "text": "Au niveau du projet, utilisez `buildFeatures { enableCompose true }`",
                    "correct": false
                },
                {
                    "text": "Au niveau de l'application, utilisez `buildFeatures { enableCompose true }`",
                    "correct": false
                }
            ],
            "type": "single"
        ...
        {
            "question": "Quel composable permet d'implémenter l'interopérabilité d'une vue ?",
            "options": [
                {
                    "text": "`InputRow`",
                    "correct": false
        ...
        {
            "question": "Qu'est-ce qu'un élément `AndroidView` ?",
            "options": [
                {
                    "text": "Un composable qui héberge un élément ou une hiérarchie de type View",
                    "correct": true
                },
                {
                    "text": "Une vue Android qui héberge le contenu de l'UI Jetpack Compose dans une mise en page de type View",
                    "correct": false
                },
                {
                    "text": "Une vue Android qui héberge une vue Android dans une mise en page de type View",
                    "correct": false
                },
                {
                    "text": "Une vue Compose qui héberge le contenu de l'UI Jetpack Compose dans une interface utilisateur Compose",
                    "correct": false
                }
            ],
            "type": "single"
        ...
        {
            "question": "Parmi les éléments suivants, lesquels sont des paramètres du composable `AndroidView` ? Plusieurs réponses possibles.",
            "options": [
                {
                    "text": "`factory`",
                    "correct": true
        ...
        {
            "question": "Le rappel `update` du composable `AndroidView` est appelé une fois que la vue correspondante a été gonflée.",
            "options": [
                {
                    "text": "Vrai",
                    "correct": true
        ...
        {
            "question": "Quelle est la fonction du lambda `factory` du composable `AndroidView` ?",
            "options": [
                {
                    "text": "Décore et améliore le composable AndroidView",
                    "correct": false
                },
                {
                    "text": "Exécute le code après le gonflement de la vue",
                    "correct": false
                },
                {
                    "text": "Crée la vue",
